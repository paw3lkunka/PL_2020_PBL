...
struct AudioSource : public Component
{
    ...
    /// Paths to AudioClips queued to play for the source
    ...
    /**
     * @brief Name (id) of the current buffer, unique in the device 
    ...
    /**
     * @brief Source's seconds offset value 
    ...
    /**
     * @brief Source's sample offset value 
    ...
    /**
     * @brief Source's byte offset value 
